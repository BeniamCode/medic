defmodule MedicWeb.UserAuth do
  @moduledoc """
  ...
  It clears the session to prevent fixation attacks. See the
  Phoenix session documentation for more information.
  """
  ...
  # This function renews the session ID and clears the whole
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      MedicWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
