      ...
      <%= if @pending_doctors_count > 0 do %>
        <div class="alert alert-warning shadow-sm">
          ...
          <div>
            ...
            <div class="text-xs">You have <%= @pending_doctors_count %> doctor application(s) pending review.</div>
          </div>
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, 
      assign(socket, 
        ...
        todays_appointments_count: 12, # Placeholder
        todays_revenue: 450 # Placeholder
      ),
